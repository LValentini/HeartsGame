...
/**
 * This class is implementing a handler for discovering the Multi-User Gaming service entity's identities and features (<a href="http://xmpp.org/extensions/xep-0030.html#info">XEP-0030</a>). This includes discovering for supported games and room configuration.
