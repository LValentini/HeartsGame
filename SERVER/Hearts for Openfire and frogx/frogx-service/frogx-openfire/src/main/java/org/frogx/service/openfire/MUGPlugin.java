...
/**
 * The MUGPlugin provides an implementation of the Openfire {@see  Plugin}  interface and a centralized management of the configured  {@see  MUGService}  and  {@see  MultiUserGame} . Game plugins can register and unregister their support within the {@see  MUGService} . Multi-User Gaming services can be configured to listen on multiple domains.
...
public class MUGPlugin implements Plugin, MUGManager {
	...
	/**
	 * The fallback description of a MUGService if no description is configured.
	 * @uml.property  name="defaultServiceDescription"
	 */
	 ...
	 * @uml.property  name="persistenceProvider"
	 * @uml.associationEnd  
	 */
	...
	/**
	 * Retrieves the default description for a  {@see  MUGService} . This description is used if none is specified.
